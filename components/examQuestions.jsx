...
//   const [timer, setTimer] = useState(900); // 30 minutes in seconds
...
//       <h2 className="exam-title">{exam.examTitle}</h2>
...
//                     style={{
//                       backgroundColor: answers[index] === option ? "#d4edda" : "",
//                       cursor: "pointer",
//                     }}
//                   >
//                     {option}
